...
But is it really a good idea to compute arithmetic means for a multi-species index? Let us do a little thought experiment. Consider two species. The population of the first one doubles from one year to the next, that is, it has an index of 2 in the second year. The population of the second one halves, it has an index of 0.5 in the second year. The arithmetic mean equals $(2 + 0.5)/2 = 1.25$, suggesting a positive trend on average. It should be clear that this is misleading: the effects of one population doubling and the one halving should cancel out each other!
